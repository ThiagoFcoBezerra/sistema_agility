...
def api_index(request):
    orcamentos = Orcamento.objects.all().values('categoria__nome').annotate(total_mes = Sum('valor_orc'))
    contexto = [{'categoria':orcamento['categoria__nome'], 'total':orcamento['total_mes']} for orcamento in orcamentos]
